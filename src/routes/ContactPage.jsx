...
let content = (
    <Fragment>
        <Container className={styles.info}>
            <div className="texts">
                <AnimatedText text={texts[0]} delay={200} styleNumber={1} speed={40} size={42}/>
                <AnimatedText text={texts[1]} delay={800} styleNumber={0} speed={40} size={26}/>
                <AnimatedText text={texts[2]} delay={1500} styleNumber={0} speed={40} size={26}/>
                <AnimatedText text={texts[3]} delay={2100} styleNumber={1} speed={40} size={42}/>
            </div>
        </Container>
